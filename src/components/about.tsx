      ...
      <div className="items-start justify-between md:flex">
        <div>
          <BlurFade delay={BLUR_FADE_DELAY * 18} inView>
            <p className="mb-6 text-justify text-base tracking-tight text-neutral-900 md:max-w-[650px] md:text-lg">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 19} inView>
            <p className="text-justify text-base tracking-tight text-neutral-900 md:max-w-[650px] md:text-lg">
